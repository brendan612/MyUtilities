...
public final class DateTimeUtilities {
    ...
    /**
     * Converts a LocalDate Object and returns it as a string.
     * Able to add a separator from the com.brendanjbishop.datetime.Separator class.
     * @param date This is the date you want converted, not null
    ...
    /**
     * Converts a LocalDate Object and returns it as a string.
     * Able to add a custom separator
     * @param date
     * @param separator
     * @return 
     */
    ...
    /**
     * Calculates how many days are left in the year. Also accommodates for leap years.
    ...
    /**
     * Takes a String date and a format and calculates how many days are left in the year. Also accommodates for leap years.
     ...
     * @throws DateTimeParseException thrown if LocalDate.parse fails to parse out the date with specified format
     */
...
requireNonNull(date,format);        
    ...
    /**
     * Calculates the amount of time, in hours, that elapsed between two LocalDateTime objects.
     * @param firstDate The starting date, not null
     * @param lastDate The ending date, not null
     * @return A double that represents the amount of hours that passed between the two LocalDateTime objects
     */
...
requireNonNull(firstDate,lastDate);        
     ...
     * @param firstDate The starting date, not null
     * @param lastDate The ending date, not null
     * @return A double that represents the amount of minutes that passed between the two LocalDateTime objects
     */
...
requireNonNull(firstDate,lastDate);        
    ...
    /**
     * Calculates the elapsed hours and minutes as a double with the decimal representing a percentage of an hour, rather than minutes
     * EX: 2.50 = 2hr(s). 30min(s).
     * @param firstDate The starting date, not null
     * @param lastDate The ending date, not null
...
requireNonNull(firstDate,lastDate);        
     ...
     * @param firstDate
     * @param lastDate
     * @return A formatted String representing hours and minutes EX: 3hr(s). 53min(s).
